...
class PIServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getNonce = channel.unary_unary(
                '/PIService/getNonce',
                request_serializer=client__pb2.UserToken.SerializeToString,
                response_deserializer=client__pb2.Nonce.FromString,
                )
        self.requestURL = channel.unary_unary(
                '/PIService/requestURL',
                request_serializer=client__pb2.PaymentInfo.SerializeToString,
                response_deserializer=client__pb2.URL.FromString,
                )
        self.requestConfirmation = channel.unary_unary(
                '/PIService/requestConfirmation',
                request_serializer=client__pb2.UserToken.SerializeToString,
                response_deserializer=client__pb2.Confirmation.FromString,
                )
...
def add_PIServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getNonce': grpc.unary_unary_rpc_method_handler(
                    servicer.getNonce,
                    request_deserializer=client__pb2.UserToken.FromString,
                    response_serializer=client__pb2.Nonce.SerializeToString,
            ),
            'requestURL': grpc.unary_unary_rpc_method_handler(
                    servicer.requestURL,
                    request_deserializer=client__pb2.PaymentInfo.FromString,
                    response_serializer=client__pb2.URL.SerializeToString,
            ),
            'requestConfirmation': grpc.unary_unary_rpc_method_handler(
                    servicer.requestConfirmation,
                    request_deserializer=client__pb2.UserToken.FromString,
                    response_serializer=client__pb2.Confirmation.SerializeToString,
            ),
    }
...
class PIService(object):
    ...
    def getNonce(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PIService/getNonce',
            client__pb2.UserToken.SerializeToString,
            client__pb2.Nonce.FromString,
    ...
    def requestURL(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PIService/requestURL',
            client__pb2.PaymentInfo.SerializeToString,
            client__pb2.URL.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def requestConfirmation(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PIService/requestConfirmation',
            client__pb2.UserToken.SerializeToString,
            client__pb2.Confirmation.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
